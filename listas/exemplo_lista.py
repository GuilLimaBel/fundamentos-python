...
def adicionar_produto(produtos, produto):
    ...
    print(f"Produto adicionado: {produto[0]}")
...
# Somando a quantidade total de produtos
...
total_produtos = quantidade_total_produtos(lista_produtos)

print(f"Quantidade total de produtos é: {total_produtos}")
...
preço_total_produtos = valor_total_produtos(lista_produtos)
print(f"O valor total dos produtos ée {preço_total_produtos}")